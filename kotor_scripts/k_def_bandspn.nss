//:: k_def_bandspn
/*
    Darth Bandon Custom On Spawn In Script
*/
...
//Aidan Feb 10, Changed the delay to 1.0 seconds to accomidate the Manaan trigger
    NoClicksFor(1.2);
    DelayCommand(1.0f, ActionStartConversation(GetFirstPC(), "k_h_bandon", FALSE, CONVERSATION_TYPE_CINEMATIC, TRUE));
